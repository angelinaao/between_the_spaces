...
const imgWidth = bg.querySelector('img').clientWidth;
bg.scrollBy({
left: imgWidth,
behavior: 'smooth'
});
...
// Configuration for dot pairs and their overlays
const dotSequence = [
...
{ from: 3, to: 4, overlayId: 'thirdoverlay', overlayDotClass: 'overlay_purpledot', dotColor: '#DE74D8' },
{ from: 4, to: 5, overlayId: 'fourthoverlay', overlayDotClass: 'overlay_greendot', dotColor: '#D3D848' },
